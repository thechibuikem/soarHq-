...
const ElibraryHeroMainComponent = () => {
  return (
    <figure className="fade-in mx-[1rem] md:mx-[3rem] md:h-[45vh] lg:h-[80vh] md:rounded-md w-auto h-[50vh] bg-[#000000bb] bg-[url('../images/ElibraryBackground.webp')] bg-cover bg-center bg-blend-darken rounded-md text-white flex flex-col justify-end mt-8 md:mt-12 lg:mt-16 mb-[1rem] sm:mb-0">
